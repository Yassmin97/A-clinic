...
const CookieBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-340 z-50 bg-white shadow-lg p-4 md:bottom-4 md:left-4 md:right-4 md:rounded-lg md:flex md:items-center md:justify-between">
