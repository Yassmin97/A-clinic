...
const Lashlift = () => {
  return (
    ...
    <div className="bg-black/35 w-full h-138 px-6 md:px-30 py-24 md:py-40">
...
<div className="flex items-center gap-2 mt-4 text-[#012840]">
  ...
  <h2 className="text-2xl font-semibold mb-4 text-center mt-30">
    Fler bilder från behandlingen
  </h2>
